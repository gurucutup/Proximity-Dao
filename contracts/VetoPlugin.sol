...
contract VetoPlugin is PluginUUPSUpgradeable, MajorityVotingBase, IMembership {
    ...
    function supportsInterface(
        bytes4 _interfaceId
    ) public view virtual override(MajorityVotingBase, PluginUUPSUpgradeable) returns (bool) {
        return
